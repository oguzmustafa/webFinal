            ...
            <div class="accordion" id="accordionExample">
                <div class="card " style="width: 90%">
                    <div class="card-header" id="headingOne">
                        ...
                        <div class="row">
                            <div class="col-4"><b>Siparis Numarasi :</b><span> 1</span> <br>
                                <b>Siparis Tarihi :</b><span> 19.06.2021</span></div>
                            <div class="col-4">
                                <div class="progress">
                                    <div class="progress bg-danger progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 75%"></div>
                                </div><br>
                                <b class="float-left danger">isleme alindi</b>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="col-5 bg-light">
                                    <a href="" class="ab">
                                        <div class="media ml-2">
                                            <img src="../img/erbaa_yaprak.jpg" style="width: 70px;height: auto" class="mr-1 mt-2" alt="...">
