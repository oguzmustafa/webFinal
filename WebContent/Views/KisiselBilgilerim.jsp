<%@ page language="java" import="Controller.uyeController,Model.uyeModel" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="col-4 ">
            ...
            <form class="needs-validation" action="bilgiControl.jsp" novalidate>
                ...
                <div class="md mt-3 ml-5">
                    ...
                    <input type="text" class="form-control" id="validationCustom01" name="ad" placeholder="Ad" value="xxx" required>
                ...
                <div class=" mt ml-5 mt-3">
                    <select class="custom-select" name="sehir" id="validationCustom04" required>
                        <option selected disabled value="">İl</option>
