    ...
    <div class="nava fx" style="width: 100%">
        <nav class="navbar navbar-light ml ">
            ...
            <form class="form-inline yer1">
                <input class="form-control mr-sm-2 opak1" id="font1" style="width: 600px;height: 50px" type="search" placeholder=" " aria-label="Search">
			...
			%>
 					...
 					<li class="nav-item hover1     ">
                    <a class="nav-link text-white " href="Sepetim.jsp"><img src="../img/sepet.png" class="img1" alt=""><span class=" rounded-circle " style="padding:3px;background-color:#89be68"><%=urunSayisi %></span><br> Sepetim</a>
                </li>
