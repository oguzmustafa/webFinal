    ...
    <div class="nava fx" style="width: 100%">
        ...
        <div class="alert  bg-dark opak2 fx " style="width:100%;" role="alert">
            <ul class="mb-4 ml-5 ul1">
                ...
                <div id="list-example">
                    <li class="li1"><a href="#list-item-1" class="aa ab" id="asd">Müşteriler</a></li>
                    <li class="li1"><a href="#list-item-2" class="aa ab">Kategoriler</a></li>
                    <li class="li1"><a href="#list-item-3" class="aa ab">Ürünler</a></li>
                    <li class="li1"><a href="#list-item-4" class="aa ab">Siparişler</a></li>
                    <li class="li1"><a href="#list-item-5" class="aa ab">Yöneticiler</a></li>
                </div>
