                                    ...
                                    <div style="margin-top:120px;" class="p-3 mb-3">
                                        <form class="needs-validation " action="urunEkle.jsp"  novalidate>
                                            ...
                                            <div class="form-group md mt-3">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="inputGroupPrepend" name="urunAdet" placeholder="adet" required>
                                                <div class="invalid-feedback">
                                                    Adet
                                                </div>
                                            </div>
											<div class="form-group md mt-3">
                                                ...
                                                <input type="file" class="form-control" aria-describedby="inputGroupPrepend" name="urunFotograf" placeholder="" required>
                                                <div class="invalid-feedback">
                                                    Adet
                                                </div>
                                            </div>
